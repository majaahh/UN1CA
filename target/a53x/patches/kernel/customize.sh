...
KERNEL_URL="https://api.github.com/repos/$REPO/android_kernel_samsung_a53x/releases/latest"
...
unset DTBO_ARCHIVE_URL DTBO_JPN_ARCHIVE_URL KERNEL_ARCHIVE_URL KERNEL_URL REPO
unset -f GET_URL
