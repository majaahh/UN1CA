...
SET_PROP "vendor" "ro.surface_flinger.enable_frame_rate_override" --delete
...
LOG "- Adding \"ro.surface_flinger.enable_frame_rate_override\" prop with \"true\" in /vendor/build.prop"
